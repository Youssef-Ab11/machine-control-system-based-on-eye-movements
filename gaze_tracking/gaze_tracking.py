...
class GazeTracking(object):
    ...
    def is_up(self):
        ...
        if self.pupils_located:
            return self.vertical_ratio() <= 0.79
    ...
    def is_right_blinking(self):
        """Returns true if the user blinks his right eye"""
        if self.pupils_located:
            return self.eye_right.blinking > 5

    def is_left_blinking(self):
        """Returns true if the user blinks his left eye"""
        if self.pupils_located:
            return self.eye_left.blinking > 5
